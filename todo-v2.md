...
- [ ] هماهنگی مسیرها با `app/` و ساختار موجود (Next.js app dir)
- [ ] پشتیبانی کامل RTL و فونت مناسب فارسی (global styles)
...
- [ ] جدول‌ها در موبایل: کارت‌ساز کردن ردیف‌ها یا اسکرول افقی کنترل‌شده
